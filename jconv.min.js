...
jconv.convert=function(d,l,g){l=getName(l);g=getName(g);if(!l||!g)throw Error("Encoding not recognized.");if(l===g)return d;d=ensureBuffer(d);var k=l+"to"+g;if(encodings[k])return encodings[k].convert(d);d=encodings[l+"toUNICODE"].convert(d);return encodings["UNICODEto"+g].convert(d)};jconv.decode=function(d,l){return jconv.convert(d,l,"UNICODE").toString("UCS2")};jconv.encode=function(d,l){return jconv.convert(d,"UTF8",l)};jconv.encodingExists=function(d){return getName(d)?!0:!1};
function getName(d){switch(d.toUpperCase()){case "WINDOWS-31J":case "CP932":case "SJIS":case "SHIFTJIS":case "SHIFT_JIS":return"SJIS";case "EUCJP":case "EUC-JP":return"EUCJP";case "JIS":case "ISO2022JP":case "ISO-2022-JP":case "ISO-2022-JP-1":return"JIS";case "UTF8":case "UTF-8":return"UTF8";case "UNICODE":case "UCS2":case "UCS-2":case "UTF16LE":case "UTF-16LE":return"UNICODE";default:return""}}
